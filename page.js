...
function updateMap(data) {
  ...
  // Overlay (z.B. markierter Wohnblock-Bereich) einzeichnen - unabhaengig von den
  ...
  try {
    ...
    if (overlayLayer) {
      // Sorgt dafuer, dass der markierte Bereich mit im sichtbaren Ausschnitt liegt,
      // auch wenn er von den Tabellen-Markern entfernt ist.
      bounds.extend(overlayLayer.getBounds());
    }
    map.fitBounds(bounds, {maxZoom: 15, padding: [0, 0]});
  } catch (err) {
